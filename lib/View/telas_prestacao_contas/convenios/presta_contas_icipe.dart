...
class PrestaIcipe extends StatelessWidget {

  String texto1 = 'Dashboard com as despesas declaradas do ICIPE/HCB:';
  ...
  Widget build(BuildContext context) {
    ...
    final Uri link1 = Uri.parse(
        'https://info.saude.df.gov.br/despesaspessoal/'
    );
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            elevation: 0,
            centerTitle: true,
            title: Text('Prestação de Contas - ICIPE/HCB',
            ...
            child: Column(
              children: <Widget>[
                ...
                ElevatedButton(
                    ...
                    child: const Text('Despesas - ICIPE/HCB')
                ),
